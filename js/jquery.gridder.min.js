...
! function(a) {
    window.console = window.console || function() {
        ...
        return this.each(function() {
            ...
            function d(d) {
                if (a(".currentGridder").removeClass("currentGridder"), g.addClass("currentGridder"), d.hasClass("selectedItem")) return void b(g, c);
        ...
        showNav: !0,
        nextText: '<i class="fa fa-arrow-left fa-3x"></i>',
        prevText: '<i class="fa fa-arrow-left fa-3x"></i>',
